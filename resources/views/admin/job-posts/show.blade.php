...
@section('content')
    ...
    <div class="panel panel-danger panel-top">
      <div class="panel-heading">
        <span class="heading">JOB CATEGORY DETAILS</span>
        <a type="button" href="{{route('job-categories.index')}}" class="btn btn-primary pull-right hidden-print"> <i class="glyphicon glyphicon-menu-left"> </i> Go To Index</a>
