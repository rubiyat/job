		...
		<div class="panel panel-danger panel-top">
		  ...
		  <div class="panel-body">
	            ...
	            <div class="form-group">
	                <div class="form-line">
	                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter user type name.....">
	                </div>
	            </div>
	            <label for="description">Description</label>
	            <div class="form-group">
	                <div class="form-line">
	                    <textarea name="description" id="description" rows="4" class="form-control no-resize" placeholder="Please type something details about user type...."></textarea>
	                </div>
	            </div>  
